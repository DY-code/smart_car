...
void pit_init (pit_index_enum pit_n, uint32 period, uint8 priority);
...
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
#define pit_ms_init(pit_n, ms,priority)  (pit_init((pit_n), (ms) * (system_clock / 1000),priority))
...
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
#define pit_us_init(pit_n, us,priority)  (pit_init((pit_n), (us) * (system_clock / 1000000),priority))
